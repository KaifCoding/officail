          ...
          <div className="flex flex-wrap -m-4">
              ...
              <div className="flex rounded-lg h-full bg-gray-800 bg-opacity-60 p-8 flex-col">
                ...
                <div className="flex-grow">
                  <p className="leading-relaxed text-base">
                    AtomProd Can Make your Website at the low Cost.
                  </p>
                  <a className="mt-3 text-red-400 inline-flex items-center">
                    Start From 600 INR                    <svg
                      fill="none"
                      stroke="currentColor"
                      stroke-linecap="round"
                      stroke-linejoin="round"
            ...
            <div className="p-4 md:w-1/3">
              <div className="flex rounded-lg h-full bg-gray-800 bg-opacity-60 p-8 flex-col">
                ...
                <div className="flex-grow">
                  <p className="leading-relaxed text-base">
                    We provide all type of Social media Followers, like, views etc.
                  </p>
                  <a href="/contact" className="mt-3 text-red-400 inline-flex items-center">
                    Contact Now
                    <svg
                      fill="none"
                      stroke="currentColor"
            ...
            <div className="p-4 md:w-1/3">
              <div className="flex rounded-lg h-full bg-gray-800 bg-opacity-60 p-8 flex-col">
                ...
                <div className="flex-grow">
                  <p className="leading-relaxed text-base">
                    We provides Our Best Editor For Your Support.
